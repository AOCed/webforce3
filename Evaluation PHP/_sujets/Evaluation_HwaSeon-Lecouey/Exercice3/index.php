<?php 
	...
	// on va récupérer les infos de la page avec fonction extractInfoPage 
	extractInfoPage();
...
<head>
	...
	<body>
		<h1>Exercice 3 : "Et si on regardait un film ? "</h1>
		<div id="chemin_fer">
			<?php
				// affichage le chemin pour arriver à cette page
				echo 'Vous etes '.displayPath($_ENV['page']);
			?>
		</div>
		<div id="menu_horizontal">
		<?php
			// affichage le menu de la page d'accueil
